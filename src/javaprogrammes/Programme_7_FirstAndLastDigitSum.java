...
public class Programme_7_FirstAndLastDigitSum {
    ...
    public static void main(String[] args) {
        Scanner scanner = new Scanner(System.in); // creating a scanner to read a data
        System.out.println("Enter number: "); // printing statement to enter input
    ...
    public static int sumFirstAndLastDigit(int number) { // with return with parameters method
